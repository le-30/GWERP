...
<div class="custom-modal-overlay"
  ...
  <div class="form-radio-group">
    <label><input type="radio" name="gender" value="1" <c:if test="${empBean.gender.equals('1') }">checked</c:if>> 남</label>
    <label><input type="radio" name="gender" value="2" <c:if test="${empBean.gender.equals('2') }">checked</c:if>> 여</label>
  </div>
</div>
